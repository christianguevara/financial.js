...
var Depreciation = ( function() {
    ...
    var db = function(cost, salvage, life, period, month) {
        ...
        var _db = function(totDepr, per) {
            var iper = Math.floor(per);
            if (iper === 0) {
